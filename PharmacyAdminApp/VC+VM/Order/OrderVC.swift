...
class OrderVC: UIViewController {
    ...
    func setupContainerController(_ controller: SwiftyPageController) {
        ...
        let firstController = ApplicationServiceProvider.shared.viewController(in: .Order, identifier: "OngoingOrderVC")
        let secondController = ApplicationServiceProvider.shared.viewController(in: .Order, identifier: "PastOrderVC")
